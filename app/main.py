...
from app.elements.simple_inputs import (
    ImageHolder,
    LatLongInputBox,
    ElevationBox,
    SiteIDBox,
...
class AddPlantScreen(Screen):
    def __init__(self):
        ...
        # Full Image box
        self.full_img_box = ImageBox(
            parent_screen=self, camera_screen_name=ScreenNames.CAMERA_SCREEN
        )
        page.add_widget(self.full_img_box)

        # Low Image box
        self.low_img_box = ImageBox(
            parent_screen=self, camera_screen_name=ScreenNames.CAMERA_SCREEN
        )
        page.add_widget(self.low_img_box)

        # Mid Image box
        self.mid_img_box = ImageBox(
            parent_screen=self, camera_screen_name=ScreenNames.CAMERA_SCREEN
        )
        page.add_widget(self.mid_img_box)

        # High Image box
        self.high_img_box = ImageBox(
            parent_screen=self, camera_screen_name=ScreenNames.CAMERA_SCREEN
        )
